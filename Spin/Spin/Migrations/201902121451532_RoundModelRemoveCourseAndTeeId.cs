namespace Spin.Migrations
{
    ...
    public partial class RoundModelRemoveCourseAndTeeId : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.RoundModels", "TeeModelId", "dbo.TeeModels", "Id", cascadeDelete: true);
            AddForeignKey("dbo.RoundModels", "CourseModelId", "dbo.CourseModels", "Id", cascadeDelete: true);
        }
